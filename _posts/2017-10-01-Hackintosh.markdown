...
Those apps respectively let you create a bootable USB, configure your Hackintosh machine and install some promary drivers in post-installation
...
* Working Mac, Hackintosh or Virtual Machine (not reccomended though) - without one of those you can’t move forward.
...
*After Creating Bootable USB, you should do some tweaks on the USB if your motherboard has no USB 2.0 Port. If you have USB 2.0, then the below steps is not needed*
...
Comment: Increase port limit[​IMG]
```
...
* **4th Step** = Drivers –> Network –> Check **IntelMausiEthernet v2.3**
...
### iMessage
<a href="https://www.tonymacx86.com/threads/an-idiots-guide-to-imessage.196827/" target="_blank">An iDiot's Guide To iMessage</a> it is the best iMessage Guide we can found on the internet, just follow this guide it is straightforward.
